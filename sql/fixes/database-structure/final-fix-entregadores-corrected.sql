-- =========================================
-- CORREÇÃO FINAL - TABELA ENTREGADORES (CORRIGIDA)
-- =========================================
...
DELETE FROM entregadores WHERE user_id = '5b9db12a-62a5-4504-8eaf-6233bbec87c4';

-- Inserir entregador para o super admin
